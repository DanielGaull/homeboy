...
fn template_parsing_tests() -> Result<(), Box<dyn Error>> {
    run_test("hello", Template::single(Clause::single(Symbol::new(SymbolInternal::Word(String::from("hello")), false))))?;
    run_test("hello?", Template::single(Clause::single(Symbol::new(SymbolInternal::Word(String::from("hello")), true))))?;
    ...
    run_test("[hello]|hello|{hello}", Template::new(vec![
        ...
        Clause::single(Symbol::new(SymbolInternal::Word(String::from("hello")), false)),
    ...
    run_test("foo bar baz", Template::single(Clause::new(vec![
        Symbol::new(SymbolInternal::Word(String::from("foo")), false),
        Symbol::new(SymbolInternal::Word(String::from("bar")), false),
        Symbol::new(SymbolInternal::Word(String::from("baz")), false),
    ])))?;
    ...
    run_test("{please} (can|would) you", Template::single(Clause::new(vec![
        ...
        Symbol::new(SymbolInternal::Template(Box::new(Template::new(vec![
            Clause::single(Symbol::new(SymbolInternal::Word(String::from("can")), false)),
            Clause::single(Symbol::new(SymbolInternal::Word(String::from("would")), false)),
        ]))), false),
        Symbol::new(SymbolInternal::Word(String::from("you")), false),
    ])))?;
